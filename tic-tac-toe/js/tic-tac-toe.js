...
class Cell {
    ...
    create() {
        this.eliment = document.createElement('div')
        this.eliment.classList.add(this.className)
    }

    activate() {
        if (this.eliment === null) return
        if(this.eliment.classList.contains(this.activeClassName))
        //добавляем слушатель события клик
        this.element.addEventListener('click', this.click)
        //добавляем класс
        this.eliment.classList.add(this.activeClassName)
    }
    ...
    deactivate() {
        ...
        //удоляем класс
        this.eliment.classList.remove(this.activeClassName)
    ...
    fill(content) {
        ...
        this.eliment.innerHtl = content
    }

    free(content) {
        if (this.eliment === null) return
        this.eliment.innerHtl = ''
    }
